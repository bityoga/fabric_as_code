sleep 300000
CORE_PEER_TLS_ROOTCERT_FILE=/root/${AGENT_HOST}/msp/tls/ca.crt 
CORE_PEER_ADDRESS=${AGENT_HOST}:7051
...
CORE_PEER_TLS_ROOTCERT_FILE=$CORE_PEER_TLS_ROOTCERT_FILE CORE_PEER_ADDRESS=$CORE_PEER_ADDRESS CORE_PEER_MSPCONFIGPATH=$CORE_PEER_MSPCONFIGPATH peer channel join -b /root/${AGENT_HOST}_cli/artifacts/appchannel.block
